...
public class ReadingAnalytics {
  ...
  public static void fillIconWeatherCodes() {
    iconWeatherCodes.put(100, "yellow sun icon");
    iconWeatherCodes.put(200, "yellow cloud sun icon");
    iconWeatherCodes.put(300, "yellow cloud icon");
    iconWeatherCodes.put(400, "blue cloud rain icon");
    iconWeatherCodes.put(500, "grey cloud showers heavy icon");
    iconWeatherCodes.put(600, "grey cloud rain icon");
    iconWeatherCodes.put(700, "pink snowman icon");
    iconWeatherCodes.put(800, "yellow bolt icon");
  }
